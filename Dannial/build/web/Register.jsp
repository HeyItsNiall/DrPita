<%-- 
    Document   : Register
    Created on : 28 Jan 2023, 10:18:49 pm
...
<html>
    ...
    <body>
        ...
        <div class="header text-center mt-5 mb-5">
            <h1> Furniture Repairing Reservation System Registration Form </h1>
        </div>

        <div class="col-10 col-lg-4 mx-auto">
            <form name="form" action="<%=request.getContextPath()%>/RegisterServlet" method="post" onsubmit="return validate(event)">
                <div class="row mb-3">
                    <div class="col-lg">
                ...
                <div class="row mb-3">
                    <div class="col-lg text-center">
                        Already has an account? <a href="Login.jsp">Login</a> here
